...
//log 往终端输出日志的方法
func (c ConLog) log(lvl uint8, msg string) {
...
//Debug 方法
func (c ConLog) Debug(msg string) {
	c.log(DEBUG, msg)
}

//Trace 方法
func (c ConLog) Trace(msg string) {
	c.log(TRACE, msg)
}

//Info 方法
func (c ConLog) Info(msg string) {
	c.log(INFO, msg)
}

//Warning 方法
func (c ConLog) Warning(msg string) {
	c.log(WARNING, msg)
}

//Error 方法
func (c ConLog) Error(msg string) {
	c.log(ERROR, msg)
}
